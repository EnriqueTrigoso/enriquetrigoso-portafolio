                          ...
                          elem.technologies_used.map((technology, index) => {
                            ...
                            return (
                              (
                                <div
                                  key={index}
                                  className='group relative overflow-hidden px-3 py-2 md:px-4 md:py-2.5 bg-gradient-to-r from-gray-600/10 to-gray-600/10 rounded-3xl border border-gray-500/10 hover:border-gray-200/30 transition-all duration-300 cursor-default'
                                  data-aos='fade-right' data-aos-duration='1000' data-aos-delay={delay}
                                >
                          ...
                          elem.key_features.map((feature, index) => {
                            ...
                            return (
                              <li
                                ...
                                data-aos='fade-left' data-aos-duration='1000' data-aos-delay={delay}
                              >
